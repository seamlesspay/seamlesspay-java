...
public class SPCharge extends ApiResource implements MetadataStore<SPCharge>, BalanceTransactionSource {
   ...
   */
  @Override
  public SPCharge update(Map<String, Object> params) throws StripeException {
   ...
   */
  @Override
  public SPCharge update(Map<String, Object> params, RequestOptions options) throws StripeException {
    String url =
        String.format(
            "%s%s",
            SPAPI.getApiBase(),
  ...
  public static class Level3 extends StripeObject {
    ...
    List<SPCharge.Level3.LineItem> lineItems;
