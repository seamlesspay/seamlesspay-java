...
@ToString
public class SPRefund extends ApiResource {
  ...
  public static SPRefundCollection list(RequestOptions options)
      throws StripeException {
    String url = String.format("%s%s", SPAPI.getApiBase(), REFUNDS_URL_PATH);
    return ApiResource.requestSPCollection(url, (ApiRequestParams) null, SPRefundCollection.class, options);
  }

  /** Create a refund. */
  public static SPRefund create(Map<String, Object> params) throws StripeException {
    return create(params, (RequestOptions) null);
  }

  /** Create a refund. */
  public static SPRefund create(Map<String, Object> params, RequestOptions options)
      throws StripeException {
    String url = String.format("%s%s", SPAPI.getApiBase(), REFUNDS_URL_PATH);
    return ApiResource.request(RequestMethod.POST, url, params, SPRefund.class, options);
  }

  /** Create a refund. */
  public static SPRefund create(SPRefundCreateParams params) throws StripeException {
    return create(params, (RequestOptions) null);
  }

  /** Create a refund. */
  public static SPRefund create(SPRefundCreateParams params, RequestOptions options) throws StripeException {
    return create(params.toMap(), options);
  }

  /** Retrieves the details of an existing refund. */
  public static SPRefund retrieve(String transactionId) throws StripeException {
    return retrieve(transactionId, null);
  }

  /** Retrieves the details of an existing refund. */
  public static SPRefund retrieve(String transactionId, RequestOptions options) throws StripeException {
    String url =
        String.format(
            "%s%s",
            SPAPI.getApiBase(), String.format(REFUNDS_URL_PATH + "/%s", ApiResource.urlEncodeId(transactionId)));
    return ApiResource.request(RequestMethod.GET, url, (Map<String, Object>) null, SPRefund.class, options);
  }
   ...
   */
  public SPRefund update(SPChargeUpdateParams params) throws StripeException {
   ...
   * provided will be left unchanged.
   */
  public SPRefund update(SPChargeUpdateParams params, RequestOptions options) throws StripeException {
    String url = String.format(
      "%s%s",
      SPAPI.getApiBase(),
      String.format(REFUNDS_URL_PATH + "/%s", ApiResource.urlEncodeId(this.getId())));
    return ApiResource.request(RequestMethod.PUT, url, params, SPRefund.class, options);
  }

  public SPRefund voidCharge(SPChargeVoidParams params) throws StripeException {
    return voidCharge(params, null);
  }

  public SPRefund voidCharge(SPChargeVoidParams params, RequestOptions options) throws StripeException {
    String url = String.format(
      "%s%s",
      SPAPI.getApiBase(),
      String.format(REFUNDS_URL_PATH + "/%s", ApiResource.urlEncodeId(this.getId())));
    return ApiResource.request(RequestMethod.DELETE, url, params, SPRefund.class, options);
  }
   ...
   */
  public SPRefund capture() throws StripeException {
    return capture(null);
  }
   ...
   * payment flow, where first you created a charge with the capture option set to false.
   */
  public SPRefund capture(RequestOptions options) throws StripeException {
    String url = String.format(
      "%s%s/%s",
      SPAPI.getApiBase(),
      REFUNDS_URL_PATH,
