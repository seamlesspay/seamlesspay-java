...
class RequestTelemetry {
  ...
  public static final String HEADER_NAME = "X-SeamlessPay-Client-Telemetry";
  ...
  /**
   * Returns an {@link Optional} containing the value of the {@code X-SeamlessPay-Telemetry} header to
   ...
   * do nothing.
   *
   * @param response the SeamlessPay response
