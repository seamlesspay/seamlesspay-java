...
public abstract class ApiRequestParams {
   ...
   */
  public static final String EXTRA_PARAMS_KEY = "_sp_java_extra_param_key";
  ...
  /**
   * Interface implemented by all enum parameter to get the actual string value that SeamlessPay API
