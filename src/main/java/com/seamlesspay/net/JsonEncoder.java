...
public class JsonEncoder {
  ...
  public static HttpContent createHttpContent(Map<String, Object> params) {
    String contentString = (params == null)
      ? ""
      : ApiResource.GSON.toJson(params);
    return new HttpContent(
      contentString.getBytes(ApiResource.CHARSET),
      "application/json");
   ...
   *
   * <p>This is a "pre-encoding" step necessary to send requests to SeamlessPay's API. Form encoding can
   * be ambiguous when it comes to nested parameters (lists or maps). SeamlessPay's API relies heavily on
