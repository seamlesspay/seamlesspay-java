...
import static com.seamlesspay.net.ApiResource.RequestMethod.POST;

/** A request to SeamlessPay's API. */
@Value
...
public class SPRequest {
  ...
  /**
   * The HTTP headers of the request ({@code Authorization}, {@code API-Version}, {@code
   * SeamlessPay-Account}, {@code Idempotency-Key}...).
   */
  HttpHeaders headers;
